...
public class DAOItens extends DAOGenerico<Itens> {
    ...
    public List<Itens> listById(int id) {
        return em.createQuery("SELECT e FROM Itens e WHERE e.vendaProdutoPK.idProduto = :id").setParameter("id", id).getResultList();
    }
    ...
    public List<Itens> listInOrderId() {
        return em.createQuery("SELECT e FROM Itens e ORDER BY e.vendaProdutoPK.idProduto").getResultList();
    }
